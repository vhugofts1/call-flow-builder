...
// Unidades e Administrativo serão definidos ao final do arquivo para evitar erros de referência
...
export const CONTATOS_SUPORTE: ResponsavelInfo[] = [
  { id: "sup1", nome: "Milena Alanes", cargo: "Supervisora Suporte", unidade: "Suporte", cor: "bg-emerald-600", iniciais: "MA", cidade: "Matriz" },
  { id: "sup2", nome: "Gabriel Mendes D.", cargo: "Atendente", unidade: "Monitoramento", cor: "bg-zinc-700", iniciais: "GM", cidade: "Matriz" },
  { id: "sup3", nome: "Lucas Fernando da Silva", cargo: "Atendente", unidade: "Monitoramento", cor: "bg-zinc-700", iniciais: "LF", cidade: "Matriz" },
  { id: "sup4", nome: "Wilson André da Silva", cargo: "Atendente", unidade: "Monitoramento", cor: "bg-zinc-700", iniciais: "WA", cidade: "Matriz" },
  { id: "sup5", nome: "Victor Hugo da Silva", cargo: "Atendente", unidade: "Suporte", cor: "bg-orange-500", iniciais: "VH", cidade: "Matriz" },
  { id: "sup6", nome: "Newton Ferreira", cargo: "Suporte e Monitoramento", unidade: "Tecnologia", cor: "bg-blue-400", iniciais: "NF", cidade: "Matriz" },
];

// Unidades (Extraído dinamicamente das 18 Cidades)
export const CONTATOS_UNIDADES: ResponsavelInfo[] = CIDADES.flatMap(cidade => 
  cidade.unidades.flatMap(unidade => 
    unidade.responsaveis.map(resp => ({
      id: resp.id,
      nome: resp.nome,
      cargo: resp.cargo,
      unidade: cidade.nome,
      cor: resp.cor,
      iniciais: resp.iniciais,
      cidade: cidade.nome
    }))
  )
);

export const MASTER_CONTATOS = [...CONTATOS_ADMIN, ...CONTATOS_SUPORTE, ...CONTATOS_UNIDADES];
